...
<main class="landing-reforma-tributaria">
    ...
    <style>
        ...
        .hero-reforma .scroll-chevrons {
            display: flex;
            flex-direction: column;
            align-items: center;
            gap: 2px;
        }
        .hero-reforma .scroll-chevrons i {
            font-size: 14px;
            color: inherit;
            opacity: 0;
            animation: scroll-chevron-cascade 1.6s ease-in-out infinite;
        }
        .hero-reforma .scroll-chevrons i:nth-child(1) { animation-delay: 0s; }
        .hero-reforma .scroll-chevrons i:nth-child(2) { animation-delay: 0.2s; }
        .hero-reforma .scroll-chevrons i:nth-child(3) { animation-delay: 0.4s; }
        @keyframes scroll-chevron-cascade {
